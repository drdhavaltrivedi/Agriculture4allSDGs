...
export const DEMO_PROJECTS: Project[] = [
  {
    ...
    description: 'A demonstration project exploring water-efficient irrigation and renewable-energy practices across a mixed-crop agricultural area in semi-arid western India.',
    area: 50,
    areaUnit: 'hectares',
  ...
  },
  {
    ...
    description: 'A demonstration project exploring soil-health practices, crop diversification, organic matter improvement, and farmer capacity building in the agricultural heartland of Anand.',
    area: 25,
    areaUnit: 'hectares',
...
export const DEMO_PROJECT_1_ANSWERS: Record<string, AssessmentAnswer> = {
  W1: {
    questionId: 'W1',
    selectedOptionIds: ['w1-opt-1'], // Significantly reduces water use
